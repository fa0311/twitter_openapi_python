...
class GrokTranslatedCommunityNoteWithAvailability(BaseModel):
    """
    GrokTranslatedCommunityNoteWithAvailability
    """ # noqa: E501
    data: Optional[GrokTranslatedCommunityNote] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GrokTranslatedCommunityNote.from_dict(obj["data"]) if obj.get("data") is not None else None,
