...
class UserHighlightsTweetsTimeline(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserHighlightsTweetsTimeline:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserHighlightsTweetsTimeline:
        """Create an instance of UserHighlightsTweetsTimeline from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserHighlightsTweetsTimeline.parse_obj(obj)

        _obj = UserHighlightsTweetsTimeline.parse_obj({
