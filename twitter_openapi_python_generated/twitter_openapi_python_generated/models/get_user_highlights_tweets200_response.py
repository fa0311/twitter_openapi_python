...
class GetUserHighlightsTweets200Response(BaseModel):
    ...
    one_of_schemas: Set[str] = { "Errors", "UserHighlightsTweetsResponse" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = GetUserHighlightsTweets200Response.model_construct()
        error_messages = []
        match = 0
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Errors, UserHighlightsTweetsResponse]]:
