...
class NotificationsViewerV2(BaseModel):
    """
    NotificationsViewerV2
    """ # noqa: E501
    user_results: NotificationsUserResults
    __properties: ClassVar[List[str]] = ["user_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_results": NotificationsUserResults.from_dict(obj["user_results"]) if obj.get("user_results") is not None else None
        })
        return _obj
