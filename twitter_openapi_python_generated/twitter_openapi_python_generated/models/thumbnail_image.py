...
class ThumbnailImage(BaseModel):
    ...
    ThumbnailImage
    """ # noqa: E501
    original_img_height: Optional[StrictInt] = None
    original_img_url: Optional[StrictStr] = None
    original_img_width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["original_img_height", "original_img_url", "original_img_width"]
