...
class ContentDisclosureAdvertisingDisclosure(BaseModel):
    """
    ContentDisclosureAdvertisingDisclosure
    """ # noqa: E501
    is_paid_promotion: StrictBool
    __properties: ClassVar[List[str]] = ["is_paid_promotion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_paid_promotion": obj.get("is_paid_promotion")
        })
        return _obj
