...
class ArticleCoverMediaColorInfo(BaseModel):
    """
    ArticleCoverMediaColorInfo
    """ # noqa: E501
    palette: List[ArticleCoverMediaColorInfoPalette]
    __properties: ClassVar[List[str]] = ["palette"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "palette": [ArticleCoverMediaColorInfoPalette.from_dict(_item) for _item in obj["palette"]] if obj.get("palette") is not None else None
        })
        return _obj
