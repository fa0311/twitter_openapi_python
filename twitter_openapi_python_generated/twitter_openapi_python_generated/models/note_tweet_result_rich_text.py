...
class NoteTweetResultRichText(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["richtext_tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "richtext_tags": [NoteTweetResultRichTextTag.from_dict(_item) for _item in obj["richtext_tags"]] if obj.get("richtext_tags") is not None else None
        })
        return _obj
