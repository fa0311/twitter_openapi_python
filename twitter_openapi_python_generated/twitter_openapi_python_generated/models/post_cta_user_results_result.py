...
class PostCtaUserResultsResult(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": PostCtaUserResultsAvatar.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None
        })
        return _obj
