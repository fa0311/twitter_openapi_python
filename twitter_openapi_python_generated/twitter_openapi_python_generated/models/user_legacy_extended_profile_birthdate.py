...
class UserLegacyExtendedProfileBirthdate(BaseModel):
    ...
    def visibility_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Self', 'Public', 'MutualFollow', 'Followers', 'Following']):
            raise ValueError("must be one of enum values ('Self', 'Public', 'MutualFollow', 'Followers', 'Following')")
        return value

    @field_validator('year_visibility')
    def year_visibility_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Self', 'Public', 'MutualFollow', 'Followers', 'Following']):
            raise ValueError("must be one of enum values ('Self', 'Public', 'MutualFollow', 'Followers', 'Following')")
        return value
