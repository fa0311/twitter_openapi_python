...
class PostCtaTitleTextEntityRef(BaseModel):
    """
    PostCtaTitleTextEntityRef
    """ # noqa: E501
    typename: TypeName = Field(alias="__typename")
    user_results: Optional[PostCtaUserResults] = None
    __properties: ClassVar[List[str]] = ["__typename", "user_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user_results": PostCtaUserResults.from_dict(obj["user_results"]) if obj.get("user_results") is not None else None
        })
        return _obj
