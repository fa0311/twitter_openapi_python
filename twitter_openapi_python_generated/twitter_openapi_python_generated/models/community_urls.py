...
class CommunityUrls(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["permalink"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of permalink
        if self.permalink:
            _dict['permalink'] = self.permalink.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permalink": CommunityUrlsPermalink.from_dict(obj["permalink"]) if obj.get("permalink") is not None else None
        })
        return _obj
