...
class TweetCardPlatformData(BaseModel):
    """
    TweetCardPlatformData
    """ # noqa: E501
    platform: TweetCardPlatform
    __properties: ClassVar[List[str]] = ["platform"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "platform": TweetCardPlatform.from_dict(obj["platform"]) if obj.get("platform") is not None else None
        })
        return _obj
