...
class OtherResponse(BaseModel):
    ...
    OtherResponse
    """
    session: Optional[Session] = Field(None, alias="Session")
    __properties = ["Session"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OtherResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OtherResponse:
        """Create an instance of OtherResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OtherResponse.parse_obj(obj)

        _obj = OtherResponse.parse_obj({
