...
class TweetEditControlInitial(BaseModel):
    ...
    """ # noqa: E501
    edit_tweet_ids: List[Annotated[str, Field(strict=True)]]
    editable_until_msecs: Annotated[str, Field(strict=True)]
    edits_remaining: Annotated[str, Field(strict=True)]
    is_edit_eligible: StrictBool
    __properties: ClassVar[List[str]] = ["edit_tweet_ids", "editable_until_msecs", "edits_remaining", "is_edit_eligible"]
