...
class TopicContext(BaseModel):
    ...
    not_interested: Optional[StrictBool] = None
    topic_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["description", "following", "icon_url", "id", "name", "not_interested", "topic_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "not_interested": obj.get("not_interested"),
