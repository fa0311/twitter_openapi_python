...
class NotificationsResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["__typename", "notification_timeline", "rest_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.notification_timeline:
            _dict['notification_timeline'] = self.notification_timeline.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification_timeline": TimelineResult.from_dict(obj["notification_timeline"]) if obj.get("notification_timeline") is not None else None,
