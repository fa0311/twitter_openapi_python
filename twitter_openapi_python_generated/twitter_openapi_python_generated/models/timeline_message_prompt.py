...
class TimelineMessagePrompt(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimelineMessagePrompt:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimelineMessagePrompt:
        """Create an instance of TimelineMessagePrompt from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimelineMessagePrompt.parse_obj(obj)

        _obj = TimelineMessagePrompt.parse_obj({
