...
class TimelineMarkEntriesUnreadGreaterThanSortIndex(BaseModel):
    """
    TimelineMarkEntriesUnreadGreaterThanSortIndex
    """ # noqa: E501
    sort_index: Optional[Annotated[str, Field(strict=True)]] = None
    type: InstructionType
    __properties: ClassVar[List[str]] = ["sort_index", "type"]
