...
class PostCreateTweetRequestVariables(BaseModel):
    ...
    disallowed_reply_options: StrictBool
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "disallowed_reply_options": obj.get("disallowed_reply_options") if obj.get("disallowed_reply_options") is not None else False,
