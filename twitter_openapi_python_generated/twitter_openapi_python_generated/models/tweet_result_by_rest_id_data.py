...
class TweetResultByRestIdData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetResultByRestIdData:
    ...
    def to_dict(self):
        ...
        if self.tweet_result:
            _dict['tweetResult'] = self.tweet_result.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TweetResultByRestIdData:
        """Create an instance of TweetResultByRestIdData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TweetResultByRestIdData.parse_obj(obj)

        _obj = TweetResultByRestIdData.parse_obj({
            "tweet_result": ItemResult.from_dict(obj.get("tweetResult")) if obj.get("tweetResult") is not None else None
        })
        return _obj
