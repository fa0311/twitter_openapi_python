...
class ArticleCoverMediaColorInfoPalette(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rgb": ArticleCoverMediaColorInfoPaletteRGB.from_dict(obj["rgb"]) if obj.get("rgb") is not None else None
        })
        return _obj
