...
class TweetTombstone(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetTombstone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetTombstone:
        """Create an instance of TweetTombstone from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TweetTombstone.parse_obj(obj)

        _obj = TweetTombstone.parse_obj({
