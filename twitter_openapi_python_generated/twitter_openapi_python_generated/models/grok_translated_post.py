...
class GrokTranslatedPost(BaseModel):
    """
    GrokTranslatedPost
    """ # noqa: E501
    associated_data: Optional[Dict[str, Any]] = None
    destination_language: Optional[StrictStr] = None
    entities: Optional[Entities] = None
    preview_translation: Optional[StrictStr] = None
    source_language: Optional[StrictStr] = None
    translation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["associated_data", "destination_language", "entities", "preview_translation", "source_language", "translation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preview_translation": obj.get("preview_translation"),
