...
OTHER200RESPONSE_ONE_OF_SCHEMAS = ["Errors", "OtherResponse"]
...
class Other200Response(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[Errors, OtherResponse]
    else:
        actual_instance: Any
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Other200Response with oneOf schemas: Errors, OtherResponse. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Other200Response with oneOf schemas: Errors, OtherResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Other200Response:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Other200Response with oneOf schemas: Errors, OtherResponse. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Other200Response with oneOf schemas: Errors, OtherResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
