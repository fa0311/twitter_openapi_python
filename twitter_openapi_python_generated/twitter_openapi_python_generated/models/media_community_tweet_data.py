...
class MediaCommunityTweetData(BaseModel):
    """
    MediaCommunityTweetData
    """ # noqa: E501
    community_results: MediaCommunityResults = Field(alias="communityResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "communityResults": MediaCommunityResults.from_dict(obj["communityResults"]) if obj.get("communityResults") is not None else None
        })
        return _obj
