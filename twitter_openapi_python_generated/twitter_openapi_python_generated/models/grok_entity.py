...
class GrokEntity(BaseModel):
    """
    GrokEntity
    """ # noqa: E501
    from_index: StrictStr
    ref: GrokEntityRef
    to_index: StrictStr
    __properties: ClassVar[List[str]] = ["from_index", "ref", "to_index"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ref": GrokEntityRef.from_dict(obj["ref"]) if obj.get("ref") is not None else None,
