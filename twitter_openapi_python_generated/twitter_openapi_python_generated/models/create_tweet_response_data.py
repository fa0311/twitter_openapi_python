...
class CreateTweetResponseData(BaseModel):
    ...
    """ # noqa: E501
    create_tweet: Optional[CreateTweetResponseResult] = None
    __properties: ClassVar[List[str]] = ["create_tweet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "create_tweet": CreateTweetResponseResult.from_dict(obj["create_tweet"]) if obj.get("create_tweet") is not None else None
        })
        return _obj
