...
class RetweetLegacy(BaseModel):
    """
    RetweetLegacy
    """
    full_text: StrictStr = Field(...)
    __properties = ["full_text"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetweetLegacy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetweetLegacy:
        """Create an instance of RetweetLegacy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetweetLegacy.parse_obj(obj)

        _obj = RetweetLegacy.parse_obj({
