...
class BookmarksResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bookmark_timeline_v2"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bookmark_timeline_v2": BookmarksTimeline.from_dict(obj["bookmark_timeline_v2"]) if obj.get("bookmark_timeline_v2") is not None else None
        })
        return _obj
