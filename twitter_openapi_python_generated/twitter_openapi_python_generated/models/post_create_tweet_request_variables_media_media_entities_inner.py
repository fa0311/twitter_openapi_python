...
class PostCreateTweetRequestVariablesMediaMediaEntitiesInner(BaseModel):
    ...
    """
    media_id: StrictStr = Field(...)
    tagged_users: conlist(Dict[str, Any]) = Field(...)
    __properties = ["media_id", "tagged_users"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCreateTweetRequestVariablesMediaMediaEntitiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostCreateTweetRequestVariablesMediaMediaEntitiesInner:
        """Create an instance of PostCreateTweetRequestVariablesMediaMediaEntitiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostCreateTweetRequestVariablesMediaMediaEntitiesInner.parse_obj(obj)

        _obj = PostCreateTweetRequestVariablesMediaMediaEntitiesInner.parse_obj({
