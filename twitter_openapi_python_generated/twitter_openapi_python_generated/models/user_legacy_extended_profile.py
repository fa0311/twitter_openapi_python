...
class UserLegacyExtendedProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["birthdate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "birthdate": UserLegacyExtendedProfileBirthdate.from_dict(obj["birthdate"]) if obj.get("birthdate") is not None else None
        })
        return _obj
