...
class TweetEditPrespective(BaseModel):
    ...
    retweeted: Optional[StrictBool] = None
    __properties = ["favorited", "retweeted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetEditPrespective:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetEditPrespective:
        """Create an instance of TweetEditPrespective from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TweetEditPrespective.parse_obj(obj)

        _obj = TweetEditPrespective.parse_obj({
