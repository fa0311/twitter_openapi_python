...
class UsersApi:
    ...
    def get_users_by_rest_ids(
        ...
        _param = self._get_users_by_rest_ids_serialize(
    ...
    @validate_call
    def get_users_by_rest_ids_with_http_info(
        self,
        path_query_id: StrictStr,
        variables: StrictStr,
        features: StrictStr,
    ...
    @validate_call
    def get_users_by_rest_ids_without_preload_content(
        self,
        path_query_id: StrictStr,
        variables: StrictStr,
        features: StrictStr,
    ...
    def _get_users_by_rest_ids_serialize(
        self,
        path_query_id,
        variables,
        features,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/graphql/{pathQueryId}/UsersByRestIds',
