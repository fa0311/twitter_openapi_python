...
class UserListApi(object):
    ...
    @validate_arguments
    def get_followers(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> FollowResponse:  # noqa: E501
    ...
    def get_followers_with_http_info(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FollowResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def get_followers_you_know(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, field_toggles : StrictStr, **kwargs) -> FollowResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_following(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> FollowResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_tweet_favoriters(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> TweetFavoritersResponse:  # noqa: E501
        """get_tweet_favoriters  # noqa: E501

        get tweet favoriters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tweet_favoriters(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TweetFavoritersResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_tweet_favoriters_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_tweet_favoriters_with_http_info(path_query_id, variables, features, **kwargs)  # noqa: E501

    @validate_arguments
    def get_tweet_favoriters_with_http_info(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_tweet_favoriters  # noqa: E501
        ...
        >>> thread = api.get_tweet_favoriters_with_http_info(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TweetFavoritersResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tweet_favoriters" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_tweet_retweeters(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> TweetRetweetersResponse:  # noqa: E501
        """get_tweet_retweeters  # noqa: E501

        get tweet retweeters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tweet_retweeters(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TweetRetweetersResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_tweet_retweeters_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_tweet_retweeters_with_http_info(path_query_id, variables, features, **kwargs)  # noqa: E501

    @validate_arguments
    def get_tweet_retweeters_with_http_info(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_tweet_retweeters  # noqa: E501
        ...
        >>> thread = api.get_tweet_retweeters_with_http_info(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TweetRetweetersResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tweet_retweeters" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
