...
class OtherApi(object):
    ...
    def other(self, **kwargs) -> OtherResponse:  # noqa: E501
        ...
        >>> thread = api.other(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the other_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.other_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def other_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """other  # noqa: E501
        ...
        >>> thread = api.other_with_http_info(async_req=True)
        >>> result = thread.get()
