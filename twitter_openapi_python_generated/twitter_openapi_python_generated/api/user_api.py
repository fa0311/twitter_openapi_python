...
class UserApi(object):
    ...
    def get_user_by_rest_id(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> GetUserByRestId200Response:  # noqa: E501
        ...
        >>> thread = api.get_user_by_rest_id(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_user_by_rest_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_user_by_rest_id_with_http_info(path_query_id, variables, features, **kwargs)  # noqa: E501

    @validate_arguments
    def get_user_by_rest_id_with_http_info(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_user_by_rest_id  # noqa: E501
        ...
        >>> thread = api.get_user_by_rest_id_with_http_info(path_query_id, variables, features, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_user_by_rest_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/graphql/{pathQueryId}/UserByRestId', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_user_by_screen_name_with_http_info(self, path_query_id : StrictStr, variables : StrictStr, features : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_by_screen_name" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/graphql/{pathQueryId}/UserByScreenName', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
