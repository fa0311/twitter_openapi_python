...
class TestNotificationsUserResults(unittest.TestCase):
    """NotificationsUserResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationsUserResults:
        """Test NotificationsUserResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationsUserResults`
        """
        model = NotificationsUserResults()
        if include_optional:
            return NotificationsUserResults(
    ...
    def testNotificationsUserResults(self):
        """Test NotificationsUserResults"""
