...
class TestTrendMetadata(unittest.TestCase):
    """TrendMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrendMetadata:
        """Test TrendMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrendMetadata`
        """
        model = TrendMetadata()
        if include_optional:
