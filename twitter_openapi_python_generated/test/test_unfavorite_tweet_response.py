...
class TestUnfavoriteTweetResponse(unittest.TestCase):
    """UnfavoriteTweetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnfavoriteTweetResponse:
        """Test UnfavoriteTweetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnfavoriteTweetResponse`
        """
        model = UnfavoriteTweetResponse()
        if include_optional:
    ...
    def testUnfavoriteTweetResponse(self):
        """Test UnfavoriteTweetResponse"""
