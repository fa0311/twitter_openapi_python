...
class TestGrokTranslatedPost(unittest.TestCase):
    """GrokTranslatedPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrokTranslatedPost:
        """Test GrokTranslatedPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrokTranslatedPost`
        """
        model = GrokTranslatedPost()
        if include_optional:
            return GrokTranslatedPost(
                associated_data = { },
    ...
    def testGrokTranslatedPost(self):
        """Test GrokTranslatedPost"""
