...
class TestArticleCoverMedia(unittest.TestCase):
    """ArticleCoverMedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArticleCoverMedia:
        """Test ArticleCoverMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArticleCoverMedia`
        """
        model = ArticleCoverMedia()
        if include_optional:
    ...
    def testArticleCoverMedia(self):
        """Test ArticleCoverMedia"""
