...
class TestUserVerificationInfoReason(unittest.TestCase):
    """UserVerificationInfoReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserVerificationInfoReason:
        """Test UserVerificationInfoReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserVerificationInfoReason`
        """
        model = UserVerificationInfoReason()
        if include_optional:
            return UserVerificationInfoReason(
    ...
    def testUserVerificationInfoReason(self):
        """Test UserVerificationInfoReason"""
