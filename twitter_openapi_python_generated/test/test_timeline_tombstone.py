...
class TestTimelineTombstone(unittest.TestCase):
    """TimelineTombstone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineTombstone:
        """Test TimelineTombstone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineTombstone`
        """
        model = TimelineTombstone()
        if include_optional:
            return TimelineTombstone(
    ...
    def testTimelineTombstone(self):
        """Test TimelineTombstone"""
